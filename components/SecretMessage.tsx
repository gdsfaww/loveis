      ...
      <div className="z-10 max-w-md w-full animate-fade-in relative">
        ...
        <div className="relative">
            ...
            <div className="relative z-10 p-10">
                ...
                <div className="mb-10">
                    <p className="font-display text-4xl md:text-5xl text-white leading-tight drop-shadow-lg mb-2 p-2">
                    "
                    </p>
                    <p className="font-body text-2xl text-slate-200 leading-relaxed italic whitespace-pre-line px-2">
                        {clue.text}
                    </p>
                    <p className="font-display text-4xl md:text-5xl text-white leading-tight drop-shadow-lg mt-2 text-right p-2">
                    "
                    </p>
                </div>

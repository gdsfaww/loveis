...
const Login: React.FC<LoginProps> = ({ onLogin }) => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-luxury-deep via-luxury-dark to-black relative overflow-hidden">
      ...
      <div className="z-10 luxury-glass p-12 rounded-[3rem] shadow-2xl max-w-md w-full text-center relative overflow-hidden group border-t border-white/10">
        ...
        <h1 className="text-6xl font-display text-gold-gradient mb-2 drop-shadow-lg tracking-wide">
          Love Quest
        </h1>
      ...
      <div className="absolute bottom-8 text-white/20 font-display text-2xl tracking-widest">
